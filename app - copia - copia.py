...
st.caption("Sube tu Excel/CSV (Billing original), presiona **Ejecutar** y descarga el TXT tabulado para el sistema contable.")
...
def read_any_csv(file_bytes):
    """CSV tolerante de entrada Billing: autodetecta separador y encoding comunes."""
...
# ---------- AGENCIAS: lectura y UI ----------
def _read_agency_df(path: Path):
    """Lee agencias.csv/.xlsx con autodetección de separador (coma, ;, tab)."""
    try:
...
fixed_agency_map = load_agencies()
